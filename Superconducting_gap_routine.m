...
% Computing the mean value of \xi along x and y
xi_along_x = [xi_x_77, xi_x_70, xi_x_65, xi_x_60, xi_x_50]; % along x
xi_along_y = [xi_y_77, xi_y_70, xi_y_65, xi_y_60, xi_y_50]; % along y

% Computing the mean
xi_x_mu = sum(xi_along_x)/length(xi_along_x); % along x
xi_y_mu = sum(xi_along_y)/length(xi_along_y); % along y
